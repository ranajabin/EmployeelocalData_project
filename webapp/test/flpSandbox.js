		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tabledatapdfdownloadproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tabledatapdfdownloadproject-display": {
								"semanticObject": "tabledatapdfdownloadproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tabledata.pdfdownloadproject",
									"url": sap.ui.require.toUrl("tabledata/pdfdownloadproject")
								}
							}
						}
					}
